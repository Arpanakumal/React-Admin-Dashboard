       ...
       position='BottomCenter'>
        ...
        onClick={()=>handleClick
          ...
          <img className='rounded-full w-8 h-8'
           src={avatar} alt="" />
           <p>
            <span className='text-gray-00 text-14'>Hi, </span> {''}
            <span className='text-gray-400 font-bold ml-1 text-14'>Arpana</span>
           </p>
           <MdKeyboardArrowDown
           className='text-gray-400 text-1'/>
